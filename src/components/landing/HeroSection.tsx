        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-6 md:space-y-8 lg:pr-4 animate-fade-in">
              ...
              <p className="text-xl text-gray-600 md:pr-2">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                <Button size="lg" className="text-md px-4 py-6">
                  Start for free
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <Button size="lg" variant="outline" className="text-md px-4 py-6">
                  Book a demo
                </Button>
              </div>
            ...
            <div className="relative lg:pl-0 animate-fade-in-up">
              <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-2 md:p-4 relative z-10">
